...
namespace CommonLibrary.CardSets
{
    public class One2OneGameSet : IGameSet
    {
        public List<CardSet> CardSets => new List<CardSet>
        {
            ...
            new CardSet(CardType.GoldCard, ImagePaths.LeftAngle_2, RouteType.LeftAngleGold, goldCount: 2),
            new CardSet(CardType.GoldCard, ImagePaths.RightAngle_1, RouteType.RightAngleGoldBlue, goldCount: 1),
            new CardSet(CardType.GoldCard, ImagePaths.RightAngle_2, RouteType.RightAngleGold, goldCount: 2),
            new CardSet(CardType.GoldCard, ImagePaths.TwoDeadEndsLeft_1, RouteType.TwoDeadEndsLeftGold, goldCount: 1),
            new CardSet(CardType.GoldCard, ImagePaths.TwoDeadEndsRight_3, RouteType.TwoDeadEndsRightGold, goldCount: 3),
            new CardSet(CardType.GoldCard, ImagePaths.LongLineWithTwoDeadEnds_1, RouteType.LongLineWithTwoDeadEnds, goldCount: 1),
            new CardSet(CardType.GoldCard, ImagePaths.ShortLineWithTwoDeadEnds_2, RouteType.ShortLineWithTwoDeadEnds, goldCount: 2),
