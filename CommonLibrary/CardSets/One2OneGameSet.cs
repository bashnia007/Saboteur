...
namespace CommonLibrary.CardSets
{
    public class One2OneGameSet : IGameSet
    {
        public List<CardSet> CardSets => new List<CardSet>
        {
            ...
            new CardSet(CardType.RouteCard, ImagePaths.CrossBlue, RouteType.CrossBlue, count: 25, hasGates: true),
            new CardSet(CardType.RouteCard, ImagePaths.CrossGreen, RouteType.CrossGreen, hasGates: true),
            ...
            new CardSet(CardType.RouteCard, ImagePaths.ThreeLinesShortBlue, RouteType.ThreeLinesShortBlue, hasGates: true),
            new CardSet(CardType.RouteCard, ImagePaths.ThreeLinesShortGreen, RouteType.ThreeLinesShortGreen, hasGates: true),
            new CardSet(CardType.RouteCard, ImagePaths.ThreeLinesShortTroll, RouteType.ThreeLinesShortTroll, isTroll: true),
            new CardSet(CardType.RouteCard, ImagePaths.ThreeLinesLongBlue, RouteType.ThreeLinesLongBlue, hasGates: true),
            new CardSet(CardType.RouteCard, ImagePaths.ThreeLinesLongGreen, RouteType.ThreeLinesLongGreen, hasGates: true),
            ...
            new CardSet(CardType.ActionCard, ImagePaths.Key, ActionType.Key, 20),
            ...
            new CardSet(CardType.GoldCard, ImagePaths.LeftAngle_1, RouteType.LeftAngleGoldGreen, goldCount: 1, hasGates: true),
            new CardSet(CardType.GoldCard, ImagePaths.LeftAngle_2, RouteType.LeftAngleGold2, goldCount: 2),
            new CardSet(CardType.GoldCard, ImagePaths.RightAngle_1, RouteType.RightAngleGoldBlue, goldCount: 1, hasGates: true),
            ...
            new CardSet(CardType.GoldCard, ImagePaths.ThreeLinesLong_1, RouteType.ThreeLinesLongBlueGold, goldCount: 1, hasGates: true),
            new CardSet(CardType.GoldCard, ImagePaths.ThreeLinesLong_2, RouteType.ThreeLinesLongGreenGold2, goldCount: 2, hasGates: true),
            new CardSet(CardType.GoldCard, ImagePaths.ThreeLinesLong_3, RouteType.ThreeLinesLongBlueGold3, goldCount: 3, hasGates: true),
            new CardSet(CardType.GoldCard, ImagePaths.ThreeLinesShort_1, RouteType.ThreeLinesShortGreenGold, goldCount: 1, hasGates: true),
            new CardSet(CardType.GoldCard, ImagePaths.ThreeLinesShort_2, RouteType.ThreeLinesShortBlueGold2, goldCount: 2, hasGates: true),
            new CardSet(CardType.GoldCard, ImagePaths.ThreeLinesShort_3, RouteType.ThreeLinesShortGreenGold3, goldCount: 3, hasGates: true),
        };
